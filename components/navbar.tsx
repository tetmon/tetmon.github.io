    ...
    <header className={`sticky top-0 z-30 grid grid-cols-12 border-b bg-white ${isWhite ? 'border-transparent' : 'border-gray-200'} 2xl:px-24`}>
      ...
      <div className='z-[1] col-end-[-2] col-start-2 flex items-center justify-between' style={{ color: isWhite ? "#ffffff" : "#215f74" }}>
        ...
        <nav className='hidden gap-8 md:flex'>
          <a href="/blog" className={`${DINish.className} rounded-xl border border-transparent px-2 py-1 font-semibold text-base ${isWhite ? 'text-white' : 'text-primary'} hover:border-gray-600`}>Blog</a>
          <a href="/about" className={`${DINish.className} rounded-xl border border-transparent px-2 py-1 font-semibold text-base ${isWhite ? 'text-white' : 'text-primary'} hover:border-gray-600`}>About</a>
        </nav>
