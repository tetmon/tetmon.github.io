  ...
  return (
    <section className="bg-neutral-200 py-24">
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-2 col-start-3 flex flex-col border-l-[1px] border-gray-400 pl-4">
          <h2 className={`text-2xl font-semibold ${DINish.className} pb-2`}>Federated quering</h2>
        ...
        <div className="col-span-2 col-start-5 flex flex-col border-l-[1px] border-gray-400 pl-4">
          <h2 className={`text-2xl font-semibold ${DINish.className} pb-2`}>Real-time access</h2>
          <p className={`${DINish.className} min-h-[110px] text-lg font-normal text-gray-600`}>
        ...
        <div className="col-span-2 col-start-7 flex flex-col border-l-[1px] border-gray-400 pl-4">
          <h2 className={`text-2xl font-semibold ${DINish.className} pb-2`}>Interactive analytics</h2>
          <p className={`${DINish.className} min-h-[110px] text-lg font-normal text-gray-600 `}>
        ...
        <div className="col-span-2 col-start-9 flex flex-col border-l-[1px] border-gray-400 pl-4">
          <h2 className={`text-2xl font-semibold ${DINish.className} pb-2`}>Security-focused</h2>
